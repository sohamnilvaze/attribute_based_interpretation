...
def particle_update_prompt(entity, particle, centroid):
    return f"""
...
Using your general knowledge and intuition, refine the estimates for {entity}.
Output ONLY the updated values as JSON with keys:
...
class RepeatedMultipleParticles:
    def __init__(
        self,
        n_particles: int,
        n_runs: int,
